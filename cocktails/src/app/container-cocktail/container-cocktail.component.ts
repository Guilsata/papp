...
@Component({
  selector: "app-container-cocktail",
  templateUrl: "./container-cocktail.component.html",
  styleUrls: ["./container-cocktail.component.scss"],
})
export class ContainerCocktailComponent implements OnInit {
  public cocktails: Cocktail[] = [
    ...
    },
    {
      ...
      description:
        "Le Bellini, en plus d’être un incontournable, extrêmement facile à réaliser puisqu’il s’agit d’un simple mélange de 10cl de Prosecco et de 5cl de purée de pêche blanche. Voilà qui devrait vous laisser le temps de préparer à vos invités une belle planche de charcuterie !",
    },
    {
      name: "Aquavit Fresh",
